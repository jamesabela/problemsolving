...
5. **Generate a Shareable Link**:
   ...
   - Base64 encode it.
   - Append to the base URL: https://jamesabela.github.io/jsfun/pythoncopy.html?code=<BASE64_STRING>&theme=dark
...
* **Example Output**:
  `[Run this code in Python Code Lab](https://jamesabela.github.io/jsfun/pythoncopy.html?code=cHJpbnQoIkhlbGxvLCBXb3JsZCEiKQ==&theme=dark)`
...
3. Copy the **Raw** URL.
4. Load it in the browser: `https://jamesabela.github.io/jsfun/pythoncopy.html?url=<RAW_URL>&theme=dark`
